        ...
        <div className="min-h-screen bg-[var(--color-bg-base)] flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-[var(--color-surface)] rounded-[var(--radius-ui)] p-8 shadow-2xl border border-[var(--color-surface-light)] relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-[32px] font-bold tracking-tight text-white mb-2 leading-tight">Create Account</h1>
                    <p className="text-[var(--color-text-muted)] text-base">Start your AI-guided wealth journey today</p>
                </div>
                ...
                {success ? (
                    <div className="mb-6 p-6 bg-[var(--color-semantic-up)]/10 border border-[var(--color-semantic-up)]/30 rounded-[var(--radius-ui)] text-[var(--color-semantic-up)] text-sm font-medium text-center">
                        <div className="mb-2 flex justify-center"><svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
                ...
                <div className="mt-8 pt-6 border-t border-[var(--color-surface-light)] text-center text-sm text-[var(--color-text-muted)]">
                    Already have an account? <Link to="/login" className="text-[var(--color-accent)] hover:text-[var(--color-accent-hover)] font-medium transition-colors ml-1">Sign in instead</Link>
                </div>
            </div>
        </div>
    )
